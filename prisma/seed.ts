...
async function main() {
  ...
  await prisma.pricingSettings.create({
    data: {
      contractorId: contractor.id,
      pricePerSquareAsphalt: 380,
      pricePerSquareMetal: 650,
      pricePerSquareTile: 520,
  ...
  // Dummy leads — varied scores, materials, urgency, statuses, and dates
  const leads = [
    {
      name: 'Sarah Mitchell',
      ...
      isHomeowner: 'yes', projectType: 'replacement', insuranceClaim: 'yes', urgency: 'emergency',
      ...
      aiLeadBrief: `• Homeowner on Shoal Creek requesting emergency asphalt replacement — likely storm or active leak situation requiring immediate attention.\n• Estimated job value $11,300 avg; score 10/10 — highest-priority lead in your pipeline right now.\n• Call within the next 1–2 hours: emergency leads contacted same day convert at 3× the rate of next-day follow-ups.`,
...
Demo Roofing Co.`,
    ...
    },
    {
      ...
      isHomeowner: 'yes', projectType: 'replacement', insuranceClaim: 'no', urgency: 'soon',
...
Demo Roofing Co.`,
    ...
    },
    {
      ...
      isHomeowner: 'yes', projectType: 'repair', insuranceClaim: 'yes', urgency: 'emergency',
      ...
      aiLeadBrief: `• Homeowner on E Cesar Chavez with an emergency repair need — likely an active leak given the urgency level selected.\n• Repair job at $7,550 avg; lower ticket but emergency repairs often lead to full replacement quotes within 3–6 months.\n• Already contacted — confirm inspection time today and document the damage for a potential upsell to full replacement.`,
...
Demo Roofing Co.`,
    ...
    },
    {
      ...
      isHomeowner: 'yes', projectType: 'replacement', insuranceClaim: 'unsure', urgency: 'soon',
      materialType: 'asphalt', roofSlope: 'medium',
    ...
    },
    {
      ...
      isHomeowner: 'yes', projectType: 'replacement', insuranceClaim: 'no', urgency: 'browsing',
      materialType: 'asphalt', roofSlope: 'medium',
    ...
    },
    {
      ...
      aiLeadBrief: `• Homeowner on Guadalupe with emergency steep-pitch replacement — urgent situation, high-value job, decisive buyer.\n• Estimated job value $14,200 avg; steep-pitch premium and emergency urgency make this a top-tier lead.\n• Marked won — great close. Follow up post-job for a Google review and referral ask.`,
...
Demo Roofing Co.`,
    ...
    },
    {
      ...
      isHomeowner: 'yes', projectType: 'replacement', insuranceClaim: 'yes', urgency: 'soon',
      materialType: 'asphalt', roofSlope: 'medium',
    ...
    },
    {
      ...
      isHomeowner: 'renter', projectType: 'repair', insuranceClaim: 'no', urgency: 'soon',
    ...
    },
    {
      ...
      isHomeowner: 'yes', projectType: 'replacement', insuranceClaim: 'unsure', urgency: 'browsing',
      ...
      aiLeadBrief: `• Homeowner on Speedway browsing options for a steep-pitch tile replacement — large job but early-stage buyer.\n• Estimated job value $21,200 avg; tile + steep pitch is a specialty combo with limited local competition.\n• Low urgency — add to a monthly nurture sequence and re-engage if they don't move forward in 30 days.`,
      aiEmailDraft: null, aiSmsDraft: null,
      daysAgo: 14,
    },
    {
...
You received 5 new leads this week with an average estimate of $14,200. Your hottest lead — Sarah Mitchell — submitted an emergency replacement request. Emergency leads represent 40% of this week's pipeline, which is above your usual rate.

**What's Hot**
Emergency replacements on the east side of Austin are trending up. Three of your five leads this week cited storm damage as the primary reason, suggesting a hail event may have impacted the 78704–78756 zip code corridor.
...
**Recommendation**
Prioritize Sarah Mitchell and Rachel Kim immediately (scores 10/10). Both are emergency replacements with high estimate values. Consider adding a service area location near Pflugerville — you had one out-of-area lead this week that you couldn't serve.`,
    },
  })
