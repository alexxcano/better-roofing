  ...
  return (
    <div className="border-2 border-stone-300 bg-white shadow-[6px_6px_0px_0px_#1c1917]">
      ...
      <div className="px-7 py-5 border-b-2 border-stone-200 bg-stone-100">
        <h1 className="font-barlow font-black text-2xl uppercase text-stone-900 leading-none">Create Account</h1>
        <p className="text-stone-500 text-xs font-semibold uppercase tracking-wide mt-1">Start capturing roofing leads today</p>
      </div>
      ...
      <div className="px-7 py-6 space-y-5">
        ...
        <button
          ...
          className="btn btn-ghost w-full py-2.5 disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {googleLoading ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="block text-xs font-black uppercase tracking-widest text-stone-600">Company Name</label>
            <input
              name="companyName"
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-black uppercase tracking-widest text-stone-600">Your Name</label>
            <input
              name="name"
