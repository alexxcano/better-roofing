  ...
  if (fetching) {
    return (
      <div className="space-y-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="h-12 bg-stone-200 animate-pulse" />
        ))}
      </div>
    )
  }
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="border-2 border-stone-300 bg-white">
        ...
        <form onSubmit={handlePricingSubmit} className="p-5 space-y-6">
          <div>
      ...
      <div className="border-2 border-stone-300 bg-white">
        ...
        <form onSubmit={handleIntegrationsSubmit} className="p-5 space-y-5">
